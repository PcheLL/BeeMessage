# **BeeMessage**
Данный программный продукт предоставляет возможность общения с другими пользователями в режиме реального времени с помощью общего чата, а также запись новых задач. 
